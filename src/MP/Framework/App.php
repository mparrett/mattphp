...
class App {
	...
	function handle(&$req, &$response = null)
	{
	...
	function process($controller, $method, $req, $response)
	{
		// Method not found
	...
	function render(&$response, $template, $vars, $req, $code = 200)
	{
	...
	function addDebugInfo(&$result, $captured, $exception)
	{
		if ($result === null)
			$result = array();
	...
	function registerCustomErrorHandler()
	{
		////
